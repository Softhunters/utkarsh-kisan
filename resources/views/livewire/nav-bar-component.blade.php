        ...
        <div class="main-menu">
            <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                <div class="mobile-logo-wrap">
                    <a href="/"><img alt="image" class="img-fluid" style="width:65px;"
                            src="{{ asset('admin/logos') }}/{{ $setting->mobile_logo }}" /><span class="logo-text">
                            {{ $setting->site_name }}</span></a>
                </div>
        ...
        <div class="nav-right d-flex jsutify-content-end align-items-center">
            ...
            <ul>
                ...
                @if (Auth::user())
                    ...
                    <a class="primary-btn1 py-1 px-3 border-0" href="{{ route('logout') }}"
                        onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
                    <form id="logout-form" method="POST" action="{{ route('logout') }}">
                        @csrf
                    </form>
                @else
                    <a class="primary-btn1 py-1 px-3 border-0" href="{{ route('new-user-login') }}">Login</a>
                @endif
            </ul>
