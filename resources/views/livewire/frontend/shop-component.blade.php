            ...
            <div class="row justify-content-center align-items-center text-center">
                ...
                <div class="col-sm-6">
                    <div class="banner-img d-block  ">
                        ...
                        <img class="img-fluid shop-banner-img" src="{{asset('assets/images/bg/inner-banner-img.png')}}" alt />
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="multiselect-bar">
                                    ...
                                    <div class="multiselect-area noneds" wire:ignore>
                                        ...
                                        <div class="single-select two ">
                                            <select class="defult-select-drowpown " id="pagesorting"  name ="pagesorting" wire:model="sorting">
