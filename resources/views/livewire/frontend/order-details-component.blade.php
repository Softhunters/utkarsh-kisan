                    ...
                    <div class="col-lg-8 col-md-8 col-12">
                        <div class="ml-0 ml-md-4 mt-md-n3">
                            ...
                            <div class="row mb-md-5">
                                ...
                                <div class="col-auto">
                                    <a href="{{route('orders')}}" class="btn btn-primary "> <i class="fa fa-angle-left"></i> Go Back</a>
                                    @if($order->status == "ordered")
                                        <a href="#" wire:click.prevent="cancelOrder" style="margin-left:20px" class="btn btn-warning pull-right">Cancel Order</a>
                                    @endif
                                </div>
                            </div>
                            </div>
                                        ...
                                        <li class="timeline-item @if($order->status == 'delivered') active @endif">
                                            ...
                                            <div class="timeline-body">  
                                                <div class="media">
                                                    ...
                                                    <div class="d-none d-sm-block">
                                                        <span class="timeline-date">{{$order->delivered_date}}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li class="timeline-item @if($order->status == 'canceled') active @endif">
                                            ...
                                            <div class="timeline-body">  
                                                <div class="media">
                                                    ...
                                                    <div class="d-none d-sm-block">
                                                        <span class="timeline-date">{{$order->canceled_date}}</span>
                                                    </div>
