...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.2/css/all.min.css" integrity="sha512-SnH5WK+bZxgPHs44uWIX+LLJAJ9/2PkPKZ5QiAj6Ta86w+fsb2TkcmfRyVX3pBnMFcV7oQPJkl9QevSCWr3W6A==" crossorigin="anonymous" referrerpolicy="no-referrer" />
            ...
            <div class="row justify-content-center align-items-center text-center">
                ...
                <div class="col-sm-6">
                    <div class="banner-img d-block  ">
                        ...
                        <img class="img-fluid category_banner_img" src="{{asset('assets/images/bg/inner-banner-img.png')}}"  alt />
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="shop-page pt-20 mb-120">
        <div class="container">
            <div class="row">
                    ...
                    <div class="shop-sidebar">
                        ...
                        <div class="shop-widget">
                            <div class="check-box-item">
                                <h5 class="shop-widget-title">{{$category_name}}</h5>
                ...
                <div class="col-lg-9 col-md-12 col-12">
                   @include('livewire.frontend.sidebar.category-sidebar-component')
                    <div class="row mb-50">
                                    ...
                                    <div class="collection-img @if($product->stock_status == "outofstock") blured @endif">
                                        ...
                                        <ul class="cart-icon-list">
                                            <li>
                                                ...
                                                @else
                                                    <a href="#" wire:click.prevent="AddtoCart({{$product->id}},{{$product->sale_price}},{{$product->seller->vendor_id??''}})"><img src="{{asset('assets/images/icon/Icon-cart3.svg')}}" alt /></a>
                                                @endif
                                                </li>
                                                <li>
                                                @if(in_array($product->id, $wishp))
                                                    <a href="#" wire:click.prevent="removeFromWishlist({{ $product->id }},{{$product->seller->vendor_id??''}})"><img src="{{asset('assets/images/icon/Icon-favorites3.svg')}}" alt /></a>
                                                @else
                                                    <a href="#" wire:click.prevent="addToWishlist({{$product->id}},{{$product->sale_price}},{{$product->seller->vendor_id??''}})"><img src="{{asset('assets/images/icon/Icon-favorites.svg')}}" alt /></a>
                                                @endif
                                            </li>
                                        </ul>
                                        @endif
...
$(function() {
  $('.bt').on('click', function() {
    $('.sidebari').addClass('is-collapsed ');
...
$(document).ready(function(){
    $(".closebtn").click(function(){
        // $(".sidebar").toggle();
            $(".sidebari").css("display", "none");
          // $(".content").css("display", "block");
          $('.content').removeClass('is-full-width');
          $('.sidebari').removeClass('is-collapsed ');
    });
});
}
</script>
