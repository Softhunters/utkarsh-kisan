                                    ...
                                    <tbody>
                                        ...
                                        @foreach($orders as $order)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex fs-6"><div class="badge badge-sa-success">@if(isset($order->transaction)){{$order->transaction->status}} @endif</div></div>
                                                </td>
                                                <td>
                                                ...
                                                <td>@if($order->prescription) Yes @else No @endif</td>
                                                <td>
