                                 ...
                                 <div class="card">
                                     <div class="card-body p-5">
                                         ...
                                         <form class="form-horizontal" enctype="multipart/form-data"
                                             wire:submit.prevent="storeBrand">
                                             <div class="mb-5">
                                            ...
                                            <div class="mb-4">
                                             ...
                                             <div class="mb-4">
                                                    <label class="col-md-4 control-label form-label ">Description<span class="text-danger"> *</span></label>
                                                    <div class="col-md-12">
                                             ...
                                             <div class="mb-4">
                                                 ...
                                                 <div class="input-group input-group--sa-slug">
                                                     ...
                                                     <input type="file" class="input-file" wire:model="brand_image" />
                                                    @if($brand_image)
                                             ...
                                             <div class="mb-4">
                                                    <label class="col-md-4 control-label form-label">Is Home</label>
                                                    <div class="col-md-4">
