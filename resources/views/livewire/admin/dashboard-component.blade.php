        ...
        <div class="row g-4 g-xl-5">
            ...
            <div class="col-12 col-md-4 d-flex">
                ...
                <div class="d-flex">    
                    ...
                    <div class="saw-indicator__body">
                        <div class="saw-indicator__value"><a href="#" class="sa-nav__link">{{$products_c}}</a></div>
                        ...
                        <table>
                            ...
                            <tbody>
                                {{-- @foreach($topProducts as $tproduct)
                                    <tr>
                                        <td>
                                            <a href="{{route('product-details',['slug'=>$tproduct->product->slug])}}" class="text-reset">{{$tproduct->product->id}}</a>
                                        </td>
                                        <td>
                                            <div class="d-flex fs-6"><div class="badge badge-sa-primary">Pending</div></div>
                                        </td>
                                        <td>
                                            <a href="{{route('product-details',['slug'=>$tproduct->product->slug])}}">{{$tproduct->product->name}}</a>
                                        </td>
                                        <td><img src="{{asset('admin/product/feat')}}/{{$tproduct->product->image}}" width="60" /></td>
                                    </tr>
                                @endforeach --}}
