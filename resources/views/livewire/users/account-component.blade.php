                            ...
                            <div class="navbar-nav flex-column">
                                ...
                                <ul class="list-unstyled mb-0">
                                    @if (auth()->user()->utype == 'VDR')
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('vendor.dashboard') }}"><i
                                                    class="bx bxs-user"></i>
                                                Vendor Dashboard <i class="fa-solid fa-chevron-right arrowo"></i></a>
                                        </li>
                                    @endif
                ...
                <div class="col-lg-8 col-md-7 col-12">
                    <div class="ml-0 ml-md-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div>
                                    <form class="row align-items-end" enctype="multipart/form-data"
                                        wire:submit.prevent="UpdateINfo">
                                        <!-- First name -->
                                        ...
                                        <div class="mb-3 col-12 col-lg-6">
                                            ...
                                            <div class="d-lg-flex d-md-flex  ">
                                                <input type="file" id="lname"
                                                    style="background-color:#5b5b5b;height: 47px;padding: 7px;"
                                                    class=" @error('newprofile') is-invalid @enderror mb-lg-0 mb-mt-0 mb-4  photo_upload"
                                                    wire:model="newprofile">
                                                @if ($newprofile)
                                                    <img src="{{ $newprofile->temporaryUrl() }}"
                                                        style="width:50px;height:45px" />
                                                @else
                                                    <img src="{{ asset('admin/profilespic') }}/{{ $profile }}"
                                                        style="width:50px;height:45px" />
                                                @endif
                                            </div>
