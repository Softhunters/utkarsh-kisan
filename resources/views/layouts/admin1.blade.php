                ...
                <div class="sa-sidebar__body" data-simplebar="">
                    <ul class="sa-nav sa-nav--sidebar" data-sa-collapse="">
                        <li class="sa-nav__section">
                            ...
                            <ul class="sa-nav__menu sa-nav__menu--root">
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon">
                                    <a href="{{route('admin.dashboard')}}" class="sa-nav__link side1 side2">
                                    <img class="sidebaar2" style="width:20px;" src="{{asset('assets/images/logo/1.png')}}" >
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                    ...
                                    <a href="#" class="sa-nav__link side1 side2" data-sa-collapse-trigger="">
                                      <img class="sidebaar2" style="width:20px;" src="{{asset('assets/images/logo/2.png')}}" >
                            ...
                            {{--    <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                    data-sa-collapse-item="sa-nav__menu-item--open">
                                    <a href="#" class="sa-nav__link side1 side2" data-sa-collapse-trigger="">
                                      <img class="sidebaar2" style="width:20px;" src="{{asset('assets/images/logo/3.png')}}" >
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                    ...
                                    <ul class="sa-nav__menu sa-nav__menu--sub" data-sa-collapse-content="">
                                        ...
                                        <li class="sa-nav__menu-item">
                                            <a href="{{ route('vendor.list', 'active') }}" class="sa-nav__link"><span
                                                    class="sa-nav__menu-item-padding"></span><span
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                    data-sa-collapse-item="sa-nav__menu-item--open">
                                    <a href="#" class="sa-nav__link side1 side2" data-sa-collapse-trigger="">
                                       <img class="sidebaar2" style="width:20px;" src="{{asset('assets/images/logo/4.png')}}" >
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                    data-sa-collapse-item="sa-nav__menu-item--open">
                                    <a href="#" class="sa-nav__link side1 side2" data-sa-collapse-trigger="">
                                      <img class="sidebaar2" style="width:20px;" src="{{asset('assets/images/logo/5.png')}}" >
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                    data-sa-collapse-item="sa-nav__menu-item--open">
                                    <a href="#" class="sa-nav__link side1 side2" data-sa-collapse-trigger="">
                                       <img class="sidebaar2" style="width:20px;" src="{{asset('assets/images/logo/6.png')}}" >
                              ...
                              {{--  <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                    ...
                                    <a href="#" class="sa-nav__link side1 side2" data-sa-collapse-trigger="">
                                       ...
                                       <img class="sidebaar2" style="width:20px;" src="{{asset('assets/images/logo/7.png')}}" >
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                    ...
                                    <a href="#" class="sa-nav__link side1 side2" data-sa-collapse-trigger="">
                                     ...
                                     <img class="sidebaar2" style="width:20px;" src="{{asset('assets/images/logo/8.png')}}" >
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                   ...
                                   <img class="sidebaar2" style="width:20px;" src="{{asset('assets/images/logo/9.png')}}" >
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                    ...
                                    <a href="#" class="sa-nav__link side1 side2" data-sa-collapse-trigger="">
                                        ...
                                        <img class="sidebaar2" style="width:20px;" src="{{asset('assets/images/logo/10.png')}}" >
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                    ...
                                    <a href="#" class="sa-nav__link side1 side2" data-sa-collapse-trigger="">
                                       ...
                                       <img class="sidebaar2" src="{{asset('assets/img/logo/order.png')}}" >
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                    ...
                                    <a href="#" class="sa-nav__link side1 side2" data-sa-collapse-trigger="">
                                       ...
                                       <img class="sidebaar2" style="width:20px;" src="{{asset('assets/images/logo/11.png')}}" >
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                    ...
                                    <a href="#" class="sa-nav__link side1 side2" data-sa-collapse-trigger="">
                                        ...
                                        <img class="sidebaar2" style="width:20px;" src="{{asset('assets/images/logo/12.png')}}" >
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                    data-sa-collapse-item="sa-nav__menu-item--open">
                                    <a href="#" class="sa-nav__link side1 side2" data-sa-collapse-trigger=""> 
                                       <img class="sidebaar2" style="width:20px;" src="{{asset('assets/images/logo/13.png')}}" >
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                    data-sa-collapse-item="sa-nav__menu-item--open">
                                    <a href="#" class="sa-nav__link side1 side2" data-sa-collapse-trigger=""> 
                                     <img class="sidebaar2" style="width:20px;" src="{{asset('assets/images/logo/14.png')}}" >
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                    data-sa-collapse-item="sa-nav__menu-item--open">
                                    <a href="#" class="sa-nav__link side1 side2" data-sa-collapse-trigger=""> 
                                        <img class="sidebaar2" style="width:20px;" src="{{asset('assets/images/logo/15.png')}}" >
                                ...
                                <li class="sa-nav__menu-item sa-nav__menu-item--has-icon">
                                    ...
                                    <img class="sidebaar2" style="width:20px;" src="{{asset('assets/images/logo/16.png')}}" >
                        ...
                        {{--    <li class="sa-nav__menu-item sa-nav__menu-item--has-icon"
                                    data-sa-collapse-item="sa-nav__menu-item--open">
                                    <a href="#" class="sa-nav__link side1 side2" data-sa-collapse-trigger=""> 
                                       <img class="sidebaar2" style="width:20px;" src="{{asset('assets/images/logo/20.png')}}" >
