...
<div class="modal clean_modal clean_modal-lg bg-white" id="search_modal" tabindex="-1" aria-labelledby="search_modal"
        aria-hidden="true">
        ...
        <div class="modal-content">
             ...
             <!--   </button>-->
                <div class="row">
                    <div class="col-12">
                        <form action="">
            <input class="form-control custom-search" style="bottom:380px;"  name="search" value="" placeholder="Search for Medicines and Health Products" type="text" wire:model="searchj" wire:keyup="productcheck">
        </form>
                    </div>
                </div>
        </div>
